...
indexes + 243 listing children = 297 public routes.**
...
| **Total** | **297** | One canonical owner per public path |
...
- Redirects required to preserve valid legacy URLs. Ordinary legacy aliases are
  operational claims outside the 297 canonical content-owner count; the one
...
- exactly 297 included canonical routes using the approved formula;
