...
**51 page documents + 2 virtual indexes + 243 listing children = 296 public
routes.**
...
The 51 in-scope WordPress page documents use these active templates:
...
- Redirects required to preserve valid legacy URLs. Redirect records are
  operational route claims, not part of the 296 canonical content-owner count.
