...
| `layouts/cookie-consent.blade.php` | 1 | Cookie-policy page plus first-party consent categories |
| **Total** | **51** |  |
...
- The home page and the hard-coded live navigation destinations for Joule,
  Request a Demo, and Contact. Request A Demo is temporarily a `302` to the
  managed Contact details, not a migrated HubSpot form.
...
- HubSpot and its unused integration/admin architecture.
...
- WordPress users. Payload authentication and roles replace them.
